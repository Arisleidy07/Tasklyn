...
export default function DashboardPage() {
  ...
  // Eager data loading - force fetch all data on mount
  useEffect(() => {
    setMounted(true);

    // Small delay to ensure stores have initialized
  ...
  // Force refresh data when user changes
  useEffect(() => {
    if (user?.id) {
      setIsLoading(true);
      // Trigger a refresh by accessing the store methods
      // This ensures subscriptions are active
      ...
      <div className="p-8 max-w-[1400px] mx-auto">
        ...
        >
          <div className="text-center">
            <div
              className={cn(
                "animate-spin w-8 h-8 border-2 border-current border-t-transparent rounded-full mx-auto mb-4",
