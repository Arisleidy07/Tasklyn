...
export default function PhotoCropperModal({
  ...
  return (
        ...
        <div className="flex items-center justify-between gap-4">
          {onDelete && currentPhotoURL && (
            <button
              ...
              className="flex items-center gap-2 min-h-[44px] px-4 rounded-xl text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-colors text-sm font-medium"
            >
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onClose}
              className="min-h-[44px] px-4 sm:px-5 rounded-xl text-white/70 hover:text-white hover:bg-white/10 transition-colors text-sm font-medium"
            >
              Cancelar
            </button>
            <button
              ...
              className="flex items-center gap-2 min-h-[44px] px-5 sm:px-6 rounded-xl bg-white text-black hover:bg-white/90 transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-white/10"
            >
              {isProcessing ? (
                <>
    ...
    >
      <div
        className="relative flex flex-col h-full min-h-[70dvh] sm:min-h-[80dvh]"
        style={{ backgroundColor: "#000" }}
      >
        {/* Header - Floating */}
        <div
          className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-3 sm:px-6 sm:py-4"
        ...
        <div className="md:hidden flex justify-center pt-4 pb-2">
          <div className="relative">
            <div
              className="w-16 h-16 rounded-full overflow-hidden ring-3 ring-white/20"
              style={{ backgroundColor: "var(--bg-secondary)" }}
            >
              {previewUrl ? (
                <img
