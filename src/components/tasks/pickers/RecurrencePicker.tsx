...
export default function RecurrencePicker({ isOpen, onClose, onSelect, currentRecurrence }: RecurrencePickerProps) {
  const [showCustom, setShowCustom] = useState(false);
  const [selectedDays, setSelectedDays] = useState<number[]>(currentRecurrence?.daysOfWeek || []);
  const [interval, setInterval] = useState(currentRecurrence?.interval || 1);
  const [customType, setCustomType] = useState<"days" | "weeks" | "months">("weeks");
  ...
  const handleCustomSave = () => {
    ...
    onSelect({
      ...
      interval,
      daysOfWeek: customType === "weeks" && selectedDays.length > 0 ? selectedDays : undefined,
    });
    setShowCustom(false);
    onClose();
  };
      ...
      {isOpen && (
        ...
        >
          ...
          {!showCustom ? (
            ...
            >
              ...
              <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-sm font-semibold text-gray-900">Repetir</h3>
                </div>
            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                <h3 className="text-sm font-semibold text-gray-900">Personalizar repetición</h3>
              ...
              <div className="p-5 space-y-5">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Frecuencia</label>
                ...
                <div className="space-y-2">
                  <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                    Cada {customType === "days" ? "cuántos días" : customType === "weeks" ? "cuántas semanas" : "cuántos meses"}
                  </label>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="flex-1 text-center text-lg font-semibold text-gray-900">{interval}</span>
                    <button
                ...
                {customType === "weeks" && (
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-500 uppercase tracking-wide">Días de la semana</label>
