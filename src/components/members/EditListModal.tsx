...
export default function EditListModal({
  ...
  return (
    <>
      ...
      >
        <div className="w-full h-full p-2 sm:p-3 space-y-2">
          {/* DETAILS SECTION */}
          {
            <div className="w-full h-full space-y-1">
              ...
              {backgroundImage ? (
                  ...
                  <div className="relative w-auto h-auto">
                    {activeBgError ? (
                      ...
                      <img
                        ...
                        className="w-auto h-auto max-w-full max-h-[40dvh] rounded-2xl"
                      />
                    )}
                ...
                <div
                  className="w-full h-32 flex flex-col items-center justify-center gap-3 rounded-2xl"
                  style={{
                    backgroundColor: "var(--bg-secondary)",
                    color: "var(--text-tertiary)",
                  }}
          ...
          {/* BACKGROUNDS SECTION */}
          {
            <div className="w-full h-full space-y-1 pb-1">
